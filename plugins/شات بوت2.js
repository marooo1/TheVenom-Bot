...
if (/^بقولك$/i.test(m.text) ) { //sem prefixo 
     conn.reply(m.chat, `قول`, m) //wm, null, [['Menu', '#menu']], m) botones :V 
}
 ...
     conn.reply(m.chat, `اوهايو كوزيماس `, m) //wm, null, [['Menu', '#menu']], m) botones :V
   ...
   if (/^جاك$/i.test(m.text) ) { //sem prefixo 
     conn.reply(m.chat,'قلب جاك اؤمرني🌚', m) //wm, null, [['Menu', '#menu']], m) botones :V
 ...
 if (/^عامل ايه$/i.test(m.text) ) { //sem prefixo 
